...
namespace NAMESPACE {
void MAIN {
    DeviceZoneScopedN("reuse-mcast-bmm-block");
    ...
    // mm_init();
    mm_block_init(tt::CB::c_in0, tt::CB::c_in1, tt::CB::c_intermed0, false, out_subblock_w, out_subblock_h, in0_block_w);
            ...
            for (uint32_t in0_subblock = 0; in0_subblock < in0_num_subblocks; in0_subblock++) {
                ...
                for (uint32_t in1_subblock = 0; in1_subblock < in1_num_subblocks; in1_subblock++) {
                    ...
                    if (enable_reload) {
                        ...
                        // }
                        copy_block_matmul_partials(tt::CB::c_intermed0, 0, 0, out_subblock_num_tiles);
                        cb_pop_front(tt::CB::c_intermed0, out_subblock_num_tiles);
                        // mm_init_short();
                        mm_block_init_short_with_dt(tt::CB::c_in0, tt::CB::c_in1, tt::CB::c_intermed0, false, out_subblock_w, out_subblock_h, in0_block_w);
                    }
                    ...
                    //             // DeviceZoneScopedN("large-block-tile");
                    ...
                    int dst_index = 0;
                    int in0_subblock_offset = in0_index_subblock_offset;
                    int in1_subblock_offset = in1_index_subblock_offset;
                    for (uint32_t inner_dim = 0; inner_dim < in0_block_w; ++inner_dim) {
                        matmul_block(
                            tt::CB::c_in0,
                            tt::CB::c_in1,
                            in0_subblock_offset + inner_dim,
                            in1_subblock_offset + inner_dim * in1_per_core_w,
                            dst_index,
                            false,
                            out_subblock_w,
                            out_subblock_h,
                    ...
                    if (last_out) {
                        ...
                        // }
                        matmul_pack_tile(0, tt::CB::c_out0, out_subblock_num_tiles);
                        tile_regs_release();
                        ...
                        // }
                        matmul_pack_tile(0, tt::CB::c_intermed0, out_subblock_num_tiles);
                        tile_regs_release();
